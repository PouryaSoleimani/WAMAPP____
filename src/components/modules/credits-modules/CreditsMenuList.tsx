    ...
    return (
        <div className='w-full VazirBold'>
            ...
            <StyledMenu
                ...
                onClose={handleClose}
            >
                <MenuItem onClick={handleClose} disableRipple sx={{ display: "flex", alignItems: "center ", justifyContent: "space-between", bgcolor: "lightgray", margin: "5px", borderRadius: "30px" }}>
                    <span className='flex items-center justify-start gap-2'>
                        <CiCircleCheck />
                        بازبرداخت ۱ ماه
                    </span>
                    <span>۸۵۶,۰۰۰ تومان</span>
                </MenuItem>
