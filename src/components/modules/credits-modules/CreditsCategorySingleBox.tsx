			...
			<CardActionArea
				...
				<CardContent sx={{ height: '100%', display: 'flex', flexDirection: 'column', padding: '8px' }}>
					...
					<div className="flex w-full items-center justify-end basis-[10%]">
						<Button component={Link} color="primary" variant="contained" to={card.path} sx={{ textDecoration: 'none', borderRadius: "8px", padding: '5px 10px', letterSpacing: '-0.5px', fontFamily: 'Vazir Bold', width: "100%" }}>
							درخواست وام
						</Button>
					</div>
				</CardContent>
