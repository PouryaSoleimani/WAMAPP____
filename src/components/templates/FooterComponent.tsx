...
const FooterItemsData = [
  ...
  return (
    <div className='text-[var(--text-primary)] bg-[var(--home-bg)] flex flex-col items-center justify-center'>

          <div dir="rtl" className="w-[90%] max-w-[500px]  flex flex-col gap-4">
