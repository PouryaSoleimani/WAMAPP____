  ...
  return (
		<section>
			...
			<div id="MAIN" className="w-screen h-screen flex items-start justify-center p-5 pt-20">
				<div className="w-full h-2/3 bg-red-600/30 rounded-lg p-3">
				  ...
				  <ul id="INNER" className='bg-blue-600/30 w-full h-full rounded-lg'>
					  <li>شهریه یکساله</li>
					  <li>تعداد ترم</li>
					  <li>میزان سود</li>
